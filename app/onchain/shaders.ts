// Shader sources for the on-chain viewer.
//
// COPIED VERBATIM from app/src/components/monolith/Stage.tsx:
//   VS_SRC        Stage.tsx lines 3-10
//   FS_NOISE_SRC  Stage.tsx lines 20-388
//   FS_BLUR_SRC   Stage.tsx lines 390-458
//
// Do NOT edit these strings. The on-chain art is frozen at the snapshot
// the metadata contract was uploaded with; any drift would change the
// rendered image for already-minted tokens. The build script
// (app/scripts/build-onchain.mjs) verifies byte-for-byte parity against
// Stage.tsx and aborts if these strings ever diverge.
