...
library TranscriptLib {
    function generateTranscript(
        ...
        uint256 publicInputsSize,
        uint256 logN
    ) public view returns (Transcript memory t) {
    ...
    function splitChallenge(Fr challenge) public pure returns (Fr first, Fr second) {
    ...
    function generateRelationParametersChallenges(
        ...
        uint256 publicInputsSize,
        Fr previousChallenge
    ) public pure returns (Honk.RelationParameters memory rp, Fr nextPreviousChallenge) {
    ...
    function generateEtaChallenge(
        ...
        uint256 vkHash,
        uint256 publicInputsSize
    ) public pure returns (Fr eta, Fr etaTwo, Fr etaThree, Fr previousChallenge) {
    ...
    function loadProof(bytes calldata proof, uint256 logN) public pure returns (Honk.Proof memory p) {
...
library RelationsLib {
     ...
     */
    function wire(Fr[NUMBER_OF_ENTITIES] memory p, WIRE _wire) public pure returns (Fr) {
...
library CommitmentSchemeLib {
    ...
    function computeSquares(Fr r, uint256 logN) public pure returns (Fr[] memory) {
