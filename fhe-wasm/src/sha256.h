// Portable, header-only SHA-256 implementation.
// Public domain / CC0. Derived from Brad Conte's crypto-algorithms.
// https://github.com/B-Con/crypto-algorithms
//
// Single-header: just #include "sha256.h" and use sha256() below.
...
// Compute SHA-256 of data[0..len-1] into out[0..31].
